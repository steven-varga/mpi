 ...
 *
 */
#ifndef  MPICPP_META_HPP 
#define  MPICPP_META_HPP
...
namespace mpi::meta::detail { // feature detection
...
namespace mpi::meta::impl {
    #define mpicpp_array__ 'a','r','r','a','y'
    #define mpicpp_char__ 'c','h','a','r'
    #define mpicpp_int__  'i','n','t'
    #define mpicpp_short__ 's','h','o','r','t'
    #define mpicpp_long__ 'l','o','n','g'
    #define mpicpp_longlong__ mpicpp_long__,' ',mpicpp_long__
    #define mpicpp_float__ 'f','l','o','a','t'
    #define mpicpp_double__ 'd','o','u','b','l','e'
    #define mpicpp_longdouble__ mpicpp_long__,' ',mpicpp_double__
    template<class T, size_t... N> struct name {
        constexpr static const char value[] =  {mpicpp_array__,'[', N..., ']', '\0'};
    };

    #define mpicpp_unsigned_name__( type__, name__ ) \
        template<size_t... N> struct name <unsigned type__,N...> { \
            constexpr static const char value[] =  {'u','n','s','i','g','n','e','d',' ',name__,'[',  N..., ']',0}; \
        };\

    #define mpicpp_signed_name__( type__, name__ ) \
        template<size_t... N> struct name <type__,N...> { \
            constexpr static const char value[] =  {name__, '[', N..., ']',0}; \
        };\

    #define mpicpp_name(type__) mpicpp_signed_name__(type__, mpicpp_##type__##__)  mpicpp_unsigned_name__(type__, mpicpp_##type__##__)
    #define mpicpp_fname(type__) mpicpp_signed_name__(type__, mpicpp_##type__##__)
    #define mpicpp_fname2(type1__, type2__) mpicpp_signed_name__(type1__ type2__, mpicpp_##type1__##type2__##__)
    #define mpicpp_name2(type1__, type2__) \
        mpicpp_signed_name__(type1__ type2__, mpicpp_##type1__##type2__##__)   \
        mpicpp_unsigned_name__(type1__ type2__, mpicpp_##type1__##type2__##__) \

    mpicpp_name(char) mpicpp_name(int) mpicpp_name(short) mpicpp_name(long) 
    mpicpp_name2(long, long)
    mpicpp_fname(float) mpicpp_fname(double)
    mpicpp_fname2(long, double)
...
template<class T> struct extent_to_string :
    mpi::meta::impl::parse<std::rank<T>::value, T>{};
}
#endif
